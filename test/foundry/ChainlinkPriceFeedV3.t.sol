...
contract ChainlinkPriceFeedV3CacheTwapIntervalIsZeroTest is ChainlinkPriceFeedV3Common {
    ...
    function test_cacheTwap_freezedReason_is_AnswerIsOutlier_update_too_frequently() public {
        _chainlinkPriceFeedV3.cacheTwap(0); // price: 1000
        ...
        _chainlinkPriceFeedV3_cacheTwap_and_assert_eq(0, uint256(price1));
        ...
        assertEq(_chainlinkPriceFeedV3.getCachedTwap(0), 910 * 1e8);
    }
}
